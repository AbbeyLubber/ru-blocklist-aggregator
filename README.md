...
**Зеркало источника — папка `Telegram/`.** Файлы содержат ровно то, что опубликовано в официальном источнике Telegram: без добавлений и без фильтрации. Если Telegram убирает диапазон из своего списка, он исчезает и здесь.
...
|---|---|---|---|---|
| `Telegram/telegram-ipv4.txt`, `Telegram/telegram-ipv6.txt` | официальный CIDR-список Telegram | каждые 12 часов | только при изменении данных | зеркало |
